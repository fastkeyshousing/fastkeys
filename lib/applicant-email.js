...
const DOCUMENTS = [
  ...
  ['Proof of income', 'Your last three payslips, or an employer statement (werkgeversverklaring). Students: your enrolment proof and, if you have one, your guarantor\'s payslips.'],
...
export function applicantEmail({ reference, application, receiptUrl, siteUrl, supportEmail }) {
  ...
  const text = [
    ...
    ``,
    `WHAT HAPPENS NEXT`,
    `  1. We read your application properly and come back within one working day.`,
    `  2. Our system watches the listing sites and applies for you the moment`,
    `     something matching appears, under your name.`,
    ...
    ``,
    `GET THESE READY (do not send them yet)`,
...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;background:#ffffff;border-radius:16px;overflow:hidden;">
  ...
  <tr><td style="padding:26px 30px 0;">
    ...
    <ol style="margin:12px 0 0;padding-left:20px;font-size:14.5px;color:#525E6D;line-height:1.7;">
      <li>We read your application properly and come back within one working day.</li>
      <li>Our system watches the listing sites and applies for you the moment something matching appears, under your name.</li>
  ...
  <tr><td style="padding:26px 30px 0;">
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#F6F7F9;border-radius:12px;">
      <tr><td style="padding:20px 22px;">
        <div style="font-size:16px;font-weight:700;color:#222A35;">Get these ready — don't send them yet</div>
